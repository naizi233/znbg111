...
import com.yzn.server.mapper.EmployeeMapper;
...
public class EmployeeServiceImpl extends ServiceImpl<EmployeeMapper, Employee> implements IEmployeeService {
    ...
    public Employee getEmp(Integer eid) {
        return employeeMapper.getEmp(eid);
    }

    @Override
    public int getSexNumbers() {
        return employeeMapper.getSexNumbers();
    }

    @Override
    public int[] getAgeNumbers() {
        int[] a=new int[2];
        a[0]=employeeMapper.getAge1Numbers();
        a[1]=employeeMapper.getAge2Numbers();
        return a;
    }

    @Override
    public List<Statistics> getTiptopDegreeNumbers() {
        return employeeMapper.getTiptopDegreeNumbers();
    }

    @Override
    public List<Statistics> getDepartmentNumbers() {
        return employeeMapper.getDepartmentNumbers();
    }

    @Override
    public int[] getPerson() {
        return employeeMapper.getPerson();
    }
