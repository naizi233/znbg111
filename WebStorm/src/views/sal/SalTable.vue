  ...
  <div>
    <div>
      ...
      <el-table
        ...
        stripe
        border
        style="width: 62%; margin-top: 10px"
      ...
      >
        ...
        <el-table-column prop="salaryEmployee" label="实发工资" width="150">
        </el-table-column>
        <el-table-column prop="seDate" label="日期" width="150">
        </el-table-column>
...
export default {
  ...
  methods:{
	  initSes() {
	    this.getRequest("salaryEmp/get-All?month="+this.month).then((resp) => {
	      if (resp) {
	        this.ses = resp;
	      }
	    });
